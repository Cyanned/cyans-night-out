...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var yellowBG:FlxSprite = new FlxSprite(-200, 500);

		for (i in 0...weekData.length)
		{
			var weekThing:MenuItem = new MenuItem(0, yellowBG.x + yellowBG.width + 10, i);
		...
		leftArrow = new FlxSprite(400, 600);
		...
		sprDifficulty = new FlxSprite(525, 600);
		...
		rightArrow = new FlxSprite(850, 600);
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		switch (curWeek)
		{
		  ...
		  case 1: 
		    yellowBG = new FlxSprite(-350, 10).loadGraphic(Paths.image('week1Banner'));
			yellowBG.scale.set(0.80, 0.80);
		  case 2: 
		    yellowBG = new FlxSprite(-350, 10).loadGraphic(Paths.image('week2Banner'));
			yellowBG.scale.set(0.80, 0.80);
		  case 3: 
		    yellowBG = new FlxSprite(-350, 10).loadGraphic(Paths.image('week3Banner'));
			yellowBG.scale.set(0.80, 0.80);
		  case 4: 
